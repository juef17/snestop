		...
		<div class="grid_12 prefix_4 suffix_4 ">
			...
			<div class="form-group">
				<label>Verifications [<a class="popup-tooltip" href="#!" title="Answer the two questions below to prove us you eat, drink and breathe. Sleep is irrelevant.">?</a>]
					...
					<span class="errors"><?=form_error('reg_calc')?></span>
				</label>
				...
				<input type="text" name="reg_captcha" maxlength="255" class="form-control" placeholder="Enter what you see in the image above" autocomplete="off">
